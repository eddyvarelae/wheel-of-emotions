...
- **Guided check-in** (~60–90s) after each spin: confirm the emotion, rate intensity 0–10, notice body sensations, name the trigger and the thought behind it (mini-CBT), pick what you need, learn what the emotion signals, choose an evidence-based regulation tool tailored to the core emotion, and end with one tiny action.
